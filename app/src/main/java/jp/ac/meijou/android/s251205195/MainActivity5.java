...
import jp.ac.meijou.android.s251205195.databinding.ActivityMain5Binding;
import okhttp3.Call;
...
public class MainActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.getButton.setOnClickListener(view -> {
            var text = binding.getEidtText.getText().toString();
//            var imageSize = binding.sizeEditText.getText().toString();

            // textパラメータをつけたURLの作成
            var url = Uri.parse("https://placehold.jp/500x500.png")
                    .buildUpon()
//                    .appendQueryParameter("size",imageSize)
            ...
            getImage(url);
            binding.getEidtText.setText(url);
        });
